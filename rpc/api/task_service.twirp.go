...
/*
Package pb_api is a generated twirp stub package.
...
func (c *taskServiceProtobufClient) Create(ctx context.Context, in *TaskCreateRequest) (*TaskCreateResponse, error) {
...
func (c *taskServiceJSONClient) Create(ctx context.Context, in *TaskCreateRequest) (*TaskCreateResponse, error) {
	ctx = ctxsetters.WithPackageName(ctx, "api")
	ctx = ctxsetters.WithServiceName(ctx, "TaskService")
	ctx = ctxsetters.WithMethodName(ctx, "Create")
	out := new(TaskCreateResponse)
...
const TaskServicePathPrefix = "/twirp/api.TaskService/"
...
func (s *taskServiceServer) ServeHTTP(resp http.ResponseWriter, req *http.Request) {
	...
	switch req.URL.Path {
	case "/twirp/api.TaskService/Create":
...
func (s *taskServiceServer) serveCreateJSON(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	...
	reqContent := new(TaskCreateRequest)
	...
	// Call service method
	var respContent *TaskCreateResponse
	func() {
	...
	if respContent == nil {
		s.writeError(ctx, resp, twirp.InternalError("received a nil *TaskCreateResponse and nil error while calling Create. nil responses are not supported"))
		return
	}
...
var twirpFileDescriptor0 = []byte{
	...
	,
}
